# Generated by Django 3.1.7 on 2021-09-23 14:29
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='ItemSalarySetting',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=200, verbose_name='نام')),
                ('label', models.CharField(max_length=200, verbose_name='عنوان')),
                ('default', models.CharField(max_length=200, verbose_name='مقدار پیشفرض')),
                ('type', models.CharField(choices=[('0', 'کسر'), ('1', 'اضافه')], max_length=1, verbose_name='نوع')),
                ('salarysetting', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='timesheet.salarysetting')),
            ],
        ),
        migrations.CreateModel(
