    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pelak', models.CharField(max_length=20, unique=True, verbose_name='پلاک')),
                ('p1', models.IntegerField(verbose_name='دو رقم اول پلاک')),
                ('p2', models.CharField(max_length=5, verbose_name='حرف پلاک')),
                ('p3', models.IntegerField(verbose_name='سه رقم پلاک')),
                ('p4', models.IntegerField(verbose_name='ایران')),
